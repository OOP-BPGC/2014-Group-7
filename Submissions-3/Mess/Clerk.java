...
public void updatePassword(String password,String id){
	...
	public static void scanCard(String id) throws SQLException, ParseException {
		...
		if(active == 0){
			...
			System.out.println("Student on leave");
			return;
			
		}
		
		if(flag == 0){
			System.out.println("Meal already consumed");
			return;
		}
		...
		System.out.println("Student can eat: "+meal);
...
public static void takeMoney() throws ParseException, SQLException {
		...
		System.out.println("Welcome Guest | Please Pay: Rs."+charge);
		Statement stmt = conn.createStatement();
