...
public class Student {
	...
	public void searchStudent (String finder, int a){
		
		this.found = SWDAdmin.find(finder, a);
	...
	public void Update() throws NumberFormatException, IOException{
		...
		case 6: SWDAdmin.viewDetails(this.id);
				break;
	...
	public void applyLeave() throws ParseException, IOException{
		...
		SWDAdmin.approveLeave(start, end, this.id);
	...
	public static void main(String args[]) throws IOException, ParseException{
		...
		do
    	{
    		...
    		switch(choice)
    		{
    			...
    			case 3: int by;
    					System.out.println("1. Using ID no.");
    					System.out.println("2. Using name");
    					by = Integer.parseInt(br.readLine());
    					switch(by){
    						case 1:	System.out.println("Enter id number");
        							String getid = br.readLine();
        							S.searchStudent(getid,1);	
    							break;
    						case 2:	System.out.println("Enter name");
									String getname = br.readLine();
									S.searchStudent(getname,2);
    							break;
    						default: System.out.println("Invalid choice.");
    					}				
    					break;
